...
static char *fonts[]          = { "monospace:size=10", "JoyPixels:pixelsize=10:antialias=true:autohint=true", "FontAwesome5Free:style=Solid:pixelsize=12", "FontAwesome5Brands:style=Solid:pixelsize=12"  };
...
static Key keys[] = {
	...
	//{ MODKEY,			XK_BackSpace,	spawn,		SHCMD("dmenubibtex") },
	//{ MODKEY|ShiftMask,		XK_BackSpace,	spawn,		SHCMD("dc-toggle") },
