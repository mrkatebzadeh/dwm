...
static const char *dmenucmd[] = { "dmen_run", NULL};
static const char *sterm[]  = { "tabbed", "-c", "-r", "2", "st", "-w", "''", NULL };
static const char *samedir[]  = { "samedir", NULL };
static const char *shutdown[]  = { "prompt", "Shutdown?", "sudo -A shutdown -h now", NULL };
static const char *reboot[]  = { "prompt", "Reboot?", "sudo -A reboot", NULL };
static const char *lockscreen[]  = { "lockscreen", NULL };
static const char *sfilemanager[]  = { "tabbed", "-c", "-r", "2", "st", "-w", "''", "-e", "ranger", NULL };
static const char *sbrowser[]  = { "tabbed", "-c", "surf", "-e", NULL };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,       XK_z,            spawn,          {.v = reboot } },
...
static Button buttons[] = {
	...
	{ ClkStatusText,        0,              Button2,        spawn,          {.v = sterm } },
